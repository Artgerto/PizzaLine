...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h4 class="h-title text-center">Форма регистрации</h4>

            <form id="main-form" class="form" action="server_signup.php" method="post" onsubmit="return CheckFormValue()">
                <div class="pre-form">
                    <p>Имя</p>
                ...
                <input class="btn-block" type="reset">
               <input class="btn-block" type="submit">
