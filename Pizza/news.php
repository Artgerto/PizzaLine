...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <h3>Досавка круглосуточно</h3>
            <hr>
            <p><i>10.05.2018</i></p>
            <p>Теперь мы принимаем заказы на доставку круглосутно!</p>
            <img class="img-fluid rounded w-100" src="img/news/img1.jpg">
            <hr>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <hr>
            <h3>Фирменная пицца по новому рецепту</h3>
            <hr>
            <p><i>05.04.2018</i></p>
